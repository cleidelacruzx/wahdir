...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary rounded">
    ...
    @include('partials._headerNav')
    		...
    		<a data-target="#createCourse" data-toggle="modal" class="btn btn-link text-white" data-toggle="tooltip" data-placement="left" title="Add Course">
...
<div class="card shadow border-0" id="example2" style="display:none">
	<div class="card-body">  <!-- div card body -->
		<table id="example" class="table-striped" id="courseTable">
			<thead>
				<tr>
					<th>No.</th>
					<th>Courses</th>
